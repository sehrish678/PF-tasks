...
int BuyProduct(string &productToBuy, int &quantity,string allMedicines[],int Quantity[],int &size);
string feedback();
...
string deleteProducts(string allMedicines[], int &medicineCount,
  ...
  bool valid6=isInteger(numOfProducts);
  if(!valid6)
  {
    goto del;
  }
...
void AlterPrice(string allMedicines[], int medicineCount,
  ...
  bool valid5=isInteger(newPrice);
  if(!valid5)
  {
    goto price;
  }
  ...
  bool valid4=isInteger(quantity);
  if(!valid4)
  {
    goto quant;
  }
...
int applyDiscount(string allMedicines[], int allProductsPrice[],
  ...
  bool valid2=isInteger(discount);
  if(!valid2)
  {
    goto dis;
  }
...
int BuyProduct(string &productToBuy, int &quantity,string allMedicines[],int Quantity[],int &size) {
  ...
  productToBuy=isAlpha(productToBuy);
   ...
   again: 
  cout << "\t\t\t\t\t\t\t\tEnter the quantity of the product: ";
  bool valid1=isInteger(quantity);
  if(!valid1)
  {
    goto again;
  }
